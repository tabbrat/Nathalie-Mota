	...
	private function get_product_pages_data( $product_pages ) {
		...
		$pages = [
			'otter-page' => [
				...
				'plugin'  => $otter_plugin,
				'strings' => [
					'heading'      => __( 'Build innovative layouts with Otter Blocks and Gutenberg', 'neve-fse' ),
					'text'         => __( 'Otter is a lightweight, dynamic collection of page building blocks and templates for the WordPress block editor.', 'neve-fse' ),
					'buttons'      => [
						'install_otter_free' => __( "Install Otter - It's free!", 'neve-fse' ),
						'install_now'        => __( 'Install Now', 'neve-fse' ),
						'learn_more'         => __( 'Learn More', 'neve-fse' ),
						'learn_more_link'    => tsdk_utmify( 'https://themeisle.com/plugins/otter-blocks/', 'otter-page', 'about-us' ),
					],
					'features'     => [
						'advancedTitle' => __( 'Advanced Features', 'neve-fse' ),
						'advancedDesc'  => __( 'Add features such as Custom CSS, Animations & Visibility Conditions to all blocks.', 'neve-fse' ),
						'fastTitle'     => __( 'Lightweight and Fast', 'neve-fse' ),
						'fastDesc'      => __( 'Otter enhances WordPress site building experience without impacting site speed.', 'neve-fse' ),
						'mobileTitle'   => __( 'Mobile-Friendly', 'neve-fse' ),
						'mobileDesc'    => __( 'Each block can be tweaked to provide a consistent experience across all devices.', 'neve-fse' ),
					],
					'details'      => [
						's1Image' => $this->get_sdk_uri() . 'assets/images/otter/otter-builder.png',
						's1Title' => __( 'A Better Page Building Experience', 'neve-fse' ),
						's1Text'  => __( 'Otter can be used to build everything from a personal blog to an e-commerce site without losing the personal touch. Otter’s ease of use transforms basic blocks into expressive layouts in seconds.', 'neve-fse' ),
						's2Image' => $this->get_sdk_uri() . 'assets/images/otter/otter-patterns.png',
						's2Title' => __( 'A New Collection of Patterns', 'neve-fse' ),
						's2Text'  => __( 'A New Patterns Library, containing a range of different elements in a variety of styles to help you build great pages. All of your website’s most important areas are covered: headers, testimonials, pricing tables, sections and more.', 'neve-fse' ),
						's3Image' => $this->get_sdk_uri() . 'assets/images/otter/otter-library.png',
						's3Title' => __( 'Advanced Blocks', 'neve-fse' ),
						's3Text'  => __( 'Enhance your website’s design with powerful blocks, like the Add to Cart, Business Hours, Review Comparison, and dozens of WooCommerce blocks.', 'neve-fse' ),
					],
					'testimonials' => [
						'heading' => __( 'Trusted by more than 300K website owners', 'neve-fse' ),
						'users'   => [
							[
	...
	private function get_other_products_data() {
		$products = [
			...
			'templates-patterns-collection'       => [
				...
				'description' => __( 'Design, save, and revisit your templates anytime with your personal vault on Templates Cloud.', 'neve-fse' ),
			],
		];
